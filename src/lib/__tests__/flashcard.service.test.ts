...
describe("FlashcardService", () => {
  ...
  describe("createBatch", () => {
    ...
    it("should throw DatabaseError on foreign key violation", async () => {
      ...
      try {
        await flashcardService.createBatch(mockUserId, [{ ...mockFlashcardDto, generation_id: 999 }]);
      } catch (error) {
    ...
    it("should throw DatabaseError on insert failure", async () => {
      ...
      // Act & Assert
      await expect(flashcardService.createBatch(mockUserId, [mockFlashcardDto])).rejects.toThrow(DatabaseError);
    });
  });
  ...
  describe("getByUserId", () => {
    it("should retrieve all flashcards for a user ordered by created_at desc", async () => {
      // Arrange
      const mockData = [mockFlashcardResponse, { ...mockFlashcardResponse, id: 2, front: "Second flashcard" }];
  ...
  describe("getById", () => {
    ...
    it("should throw DatabaseError for non-PGRST116 errors", async () => {
      ...
      // Act & Assert
      await expect(flashcardService.getById(flashcardId, mockUserId)).rejects.toThrow(DatabaseError);
    });
  });
  ...
  describe("update", () => {
    ...
    it("should throw DatabaseError when update fails", async () => {
      ...
      // Act & Assert
      await expect(flashcardService.update(flashcardId, mockUserId, updates)).rejects.toThrow(DatabaseError);
    });
  });
  ...
  describe("delete", () => {
    ...
    it("should throw DatabaseError when delete fails", async () => {
      ...
      // Act & Assert
      await expect(flashcardService.delete(flashcardId, mockUserId)).rejects.toThrow(DatabaseError);
    });
  });
  ...
  describe("validateGenerationIds", () => {
    it("should validate existing generation IDs successfully", async () => {
      ...
      // Act & Assert
      await expect(flashcardService.validateGenerationIds(generationIds)).resolves.not.toThrow();
    });
    ...
    it("should throw DatabaseError when generation IDs count mismatch", async () => {
      ...
      // Act & Assert
      await expect(flashcardService.validateGenerationIds(generationIds)).rejects.toThrow(DatabaseError);
